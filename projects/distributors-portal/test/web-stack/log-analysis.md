...
## :material-clock: Última actualización
...
## :material-check-circle: Resumen ejecutivo

!!! success "Estado general: Saludable"
...
## :material-account: Actividad de usuarios (sesiones Drupal)
...
## :material-web: Última navegación registrada (12:35)
...
## :material-alert-circle-outline: Errores y warnings
...
## :material-chart-line: Estadísticas rápidas
...
## :material-history: Historial de sesiones
...
## :material-information: Tipos de análisis disponibles
...
## :material-database: Fuentes consultadas en este análisis
