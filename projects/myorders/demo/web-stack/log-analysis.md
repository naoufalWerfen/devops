...
> 🔴 **Impacto: Alto** — Ruido en logs + fuga de información
...
- Clientes con username "NOT FOUND": ~**12 intentos**
...
> ⚠️ **Impacto: Alto** — Degradación de rendimiento
...
> ⚠️ **Impacto: Medio** — Funcionalidad admin degradada
...
> ⚠️ **Impacto: Medio** — Errores silenciosos en producción
...
> ℹ️ **Impacto: Bajo-Medio** — Indica problemas de conectividad persistente
...
|---------|----|-----------|
| Jun 2025 | orders_demo | ~2/día (cada ~11h) |
...
> ℹ️ **Impacto: Bajo** — Ruta no encontrada
...
> ℹ️ **Impacto: Informativo** — Actividad de threat intelligence
...
> ⚠️ **Impacto: Bajo** — Indicador de procesos colgados
